...
%such as virtualization or other isolation mechanisms
...
However, this level of information is \yanyan{xxx (less accurate or 
something) compared to Lind.}
...
\yanyan{In contrast, Lind...(and related to the new results).}
%Our work is motivated by Schroter et al.~\cite{schroter2006predicting} and 
%Neuhaus et al.~\cite{neuhaus2007predicting}. 
%Schroter~\cite{schroter2006predicting} observed that bugs and
%failures are correlated in code via \texttt{import} and function calls. 
%Neuhaus~\cite{neuhaus2007predicting} 
...
if this paragraph should be cut.}
...
%are commonly used in application-level sandboxing. 
%These languages provide virtualized environments to
