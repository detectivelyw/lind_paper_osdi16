...
In this paper, we are one step closer to that goal by the development 
...
networking, threading, and memory management. \yanyan{how do you decide these are essential?}
...
while passing the system calls \yanyan{invoked by the binary?} to the operating system interface. 
