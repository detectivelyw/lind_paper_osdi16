...
\cappos{line-of-code ?} level.  We compare to other proposed metrics
...
design scheme. \cappos{You shouldn't say `development' of a design scheme. 
It's very odd to read.}
