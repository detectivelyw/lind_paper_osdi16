...
use, and so fewer bugs can go undetected. 
...
Furthermore, when comparing our metric against two earlier strategies for predicting bug
...
for Debian 7.0. %, a widely-used and popular open source project.
...
\cappos{I'm not sure why this matters}
...
\yanyan{what if people ask "is it possible to create new functionality using old code"?}

Another metric, reported by Chou, et al.~\cite{PittSFIeld}, showed that certain parts of the kernel
were more vulnerable than others. In particular, they identified that device drivers
have much more vulnerabilities.
...
One reason for this relatively low number is that, after Chou's study was published,
...
{\bf file vs line granularity} Over the years, a number of metrics for identifying bugs in the OS kernel have
...
and areas of code they identify. In contrast, our metric of popular
