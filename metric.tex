...
bug appearing in these popular paths.  \cappos{Is it common in OSDI papers
...
software, communicated with friends and family, and other tasks, using this 
...
this will overestimate because reaching the lines of kernel code where a 
...
section.  We say a lot without saying a lot...}
