...
bugs. By understanding how %and when
lines of code in the kernel are used, %down to the level of lines of code, we
...
To trace the kernel, we used \texttt{gcov}~\cite{gcov}, a standard program profiling tool with
...
will be found in the future. \yanyan{our test is based on past bugs. how 
to predict the future then?} For the remainder of the paper, we will
