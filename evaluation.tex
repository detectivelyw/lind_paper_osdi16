...
computation produced the additional overhead. It should be noted that, for the six applications that we tested,
Lind managed to control the performance slowdown to a
level that is barely noticeable to users, even
 with the current overhead.\lois{Do we have proof that its barely noticeable to users?
 Otherwise I would cut this line.} The fact that the total execution time was limited
