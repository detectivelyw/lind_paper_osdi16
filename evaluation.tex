...
\textbf{Test Purpose.}\lois{Note---this is our goal--what we set out to do. I don't
think it needs to be a complete sentence...goals are often stated this way.
...
The results are shown in Table \ref{table:trace-Repy}. The trace of Repy\lois{Why is it
Repy here and SafePosix in the subhead?} is
