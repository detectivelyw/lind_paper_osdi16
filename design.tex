...
reimplementation," \yanyan{is this the official name?} 
...
very small trusted computer base. \yanyan{what is popular code requests?}
...
one component of the trusted computing base. \yanyan{why posing great threat
makes it part of TCB?}
...
with incorrect permissions and privileges. \yanyan{I find it hard to understand
...
legal and harmless in the guest OS may open up \yanyan{risky?} system call paths in the underlying
...
complex calls, such as file system calls. \yanyan{not all file system calls are complex.}
